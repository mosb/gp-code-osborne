...
if isstr(nsample_ix); nsample_ix = str2double(nsample_ix); end
...
run_one_experiment( problems{problem_number}, methods{method_number}, ...
                    sample_sizes(nsample_ix), repitition, outdir, 0 );
