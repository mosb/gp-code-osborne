...
dla4747.dimension = 9;
dla4747.prior.mean = [mle_means(1:2),...
...
dla4389.dimension = 9;
dla4389.prior.mean = [mle_means(1:2),...
    maximum_dla_location - dla_offset_prior_mean, ...
	dla_width_prior_mean, ...
    dla_width_prior_mean, ... 
    mle_means(2) / 5, ...
...
% create_spectrum_likelihood_handle_dla;
% 
% dla4389.name = 'dla 3664';
% dla4389.description = 'dla problem drawn from sdss data, plate = 3664, mjd = 55245, fiber = 0012';
% dla4389.dimension = 9;
% dla4389.prior.mean = [mle_means(1:2),...
%     maximum_dla_location - dla_offset_prior_mean, ...
% 	dla_width_prior_mean, ...
...
dla4290.dimension = 9;
dla4290.prior.mean = [mle_means(1:2),...
    maximum_dla_location - dla_offset_prior_mean, ...
	dla_width_prior_mean, ...
    dla_width_prior_mean, ... 
    mle_means(2) / 5, ...
