...
root = '/homes/mlghomes/dkd23/Dropbox/code/gp-code-osborne/kepler/SBQ_RVs'
mayor = 'RVs_Mayor2009'
vogt = 'RVs_Vogt2010'
...
if __name__ == "__main__":
    ...
    for i in range(n_inst):
        l = (x[1,:] == i)
        plt.errorbar(x[0,l], y[0,l], yerr = np.sqrt(y[1,l]), \
                     fmt = '.', color = col[i], ecolor = col[i], label = lab[i])
    plt.show()
    par = [1.89, 1.89, 1.13, -0.35, \
           5.36849, 12.5, 0.0, 0.007, 2.4]
