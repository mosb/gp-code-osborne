...
two_humps_1d.true_log_evidence = ...                             
    logsumexp([log_volume_between_two_gaussians(two_humps_1d.prior.mean, ...
                                     two_humps_1d.prior.covariance, ...
                                     likelihood.mean1, likelihood.covariance1), ...
              log_volume_between_two_gaussians(two_humps_1d.prior.mean, ...
                                     two_humps_1d.prior.covariance, ...
...
two_humps_4d.true_log_evidence = ...
    logsumexp([log_volume_between_two_gaussians(two_humps_4d.prior.mean, ...
                                     two_humps_4d.prior.covariance, ...
                                     likelihood.mean1, likelihood.covariance1), ...
              log_volume_between_two_gaussians(two_humps_4d.prior.mean, ...
                                     two_humps_4d.prior.covariance, ...
                                     likelihood.mean2, likelihood.covariance2)]);                                 
